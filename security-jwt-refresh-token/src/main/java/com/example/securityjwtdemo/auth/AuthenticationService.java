...
public class AuthenticationService {
    ...
    public AuthenticationResponse register(RegisterRequest request) {
        ...
        // create access token, refresh token + save access token to db + fill response info back to user
    ...
    public AuthenticationResponse authenticate(AuthenticationRequest request) {
        ...
        // create tokens + save token into db + fill response info back to user
        var jwtToken = jwtService.generateToken(user);
        var refreshToken = jwtService.generateRefreshToken(user);
    ...
    public void refreshToken(HttpServletRequest request,
        ...
        if(userEmail != null) {
            ...
            if (jwtService.isTokenValid(refreshToken, user)) {
                ...
                // revoke all user access token and save the new one to db
                revokeAllUserTokens(user);
